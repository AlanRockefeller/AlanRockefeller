<!-- Auto-generated on 2026-02-14. Edit or regenerate via make_readme.py -->

![Hero](hero.jpg)

**El Cerrito, California** · **Mycology + DNA barcoding** · **Field photography** · **Fungal microscopy**

Mycologist, researcher, educator, consultant and keynote speaker specializing in DNA barcoding, field photography, and fungal microscopy.
...
- **[taxonomybot.py](https://github.com/AlanRockefeller/taxonomybot.py)** — A PyWikiBot that runs on mycomap.org and adds References and Gallery sections to wiki pages tha…
